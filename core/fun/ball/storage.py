...
eight_ball_answers = {
    "ru_ru": (
        ...
        "Звёзды говорят 'да'",
        "Да",
        "Пока что ещё сложно сказать, попробуй ещё раз" "Спроси позже",
        "Об этом лучше не рассказывать",
        "Сейчас нельзя это сказать",
        "Спроси ещё раз",
        "Да быть такого не может!" "Конечно же нет!",
        "Весьма сомнительно",
        "Нет! Нет! Нет! Нет!",
        "Нет",
    ),
    "en_us": (
        ...
        "Concentrate and ask again" "I am tired. *proceeds with sleeping*",
    ),
}
