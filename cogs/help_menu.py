    ...
    def __init__(self):
        ...
        options = [
            nextcord.SelectOption(
                label="Информация", description="Меню помощи по разделу 'информация'", emoji="📝"
            ),
            nextcord.SelectOption(
                label="Модерация", description="Меню помощи по разделу 'Модерация'", emoji="🛡️"
            ),
            nextcord.SelectOption(
                label="Экономика", description="Меню помощи по разделу 'Экономика'", emoji="💸"
            ),
            nextcord.SelectOption(
                label="Уровни", description="Меню помощи по разделу 'Экономика'", emoji="🐉"
            ),
            nextcord.SelectOption(
                label="Любовь и свадьбы", description="Меню помощи по разделу 'Экономика'", emoji="🤍"
            ),
            nextcord.SelectOption(
                label="Приветствия и прощания", description="Меню помощи по разделу 'Экономика'", emoji="👋"
            ),
            nextcord.SelectOption(
                label="Благодарности за нитро буст(alpha)", description="Меню помощи по разделу 'Экономика'", emoji="💎"
            ),
            nextcord.SelectOption(
                label="Эмоции, Реакции", description="Меню помощи по разделу 'Эмоции, Реакции'", emoji="😊"
            ),
            nextcord.SelectOption(
                label="Тикеты", description="Меню помощи по разделу 'Тикеты'", emoji="🎟️"
            ),
            nextcord.SelectOption(
                label="Логи, Логирование событий", description="Меню помощи по разделу 'Логи'", emoji="📄"
            ),
            nextcord.SelectOption(
                label="Топы", description="Меню помощи по разделу 'Топы'", emoji="🏆"
            ),
            nextcord.SelectOption(
                label="Локализации", description="Меню помощи по разделу 'Локализации'", emoji="📙"
            ),
            nextcord.SelectOption(
                label="Профили", description="Меню помощи по разделу 'Профили'", emoji="👤"
            ),
            nextcord.SelectOption(
                label="Статистика", description="Меню помощи по разделу 'Статистика'", emoji="📈"
            ),
            nextcord.SelectOption(
                label="Автороли", description="Меню помощи по разделу 'Автороли'", emoji="⚙️"
            ),
        ]
        super().__init__(
...
class HelpMenu(commands.Cog):
    ...
    async def __help(self, interaction: Interaction):
        ...
        view = HelpMenuView()
        embed.set_image(
            url="https://c.tenor.com/K0hCHT6qFbMAAAAd/mobius-pixel-art.gif")
