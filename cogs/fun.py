...
class Funny(commands.Cog):
    ...
    @nextcord.slash_command(
        name="dog",
        description="Send's random picture of dog",
    ...
    @nextcord.slash_command(
        name="fox",
        description="Send's random picture of fox",
    ...
    @nextcord.slash_command(
        name="bird",
        description="Send's random picture of bird",
    ...
    @nextcord.slash_command(
        name="panda",
        description="Send's random picture of panda",
